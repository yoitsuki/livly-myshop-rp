...
interface Props {
  onMenuClick: () => void;
  /** When true, shows a back button instead of the hamburger. */
  back?: boolean;
      ...
      <div className="max-w-screen-sm mx-auto px-3 py-2.5 flex items-center gap-3">
        ...
        {!hideSettings && (
          <Link
            href="/settings"
            aria-label="設定"
            className="p-2 -mr-1 rounded-full hover:bg-beige/60 active:bg-beige transition-colors text-text/80"
          >
